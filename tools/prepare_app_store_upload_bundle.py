...
METADATA = {
    "en-US": {
        ...
        "release_notes": "Arabic joins Alike, and the whole app reads right to left.\n\n- Every screen, plus the App Store page and the privacy, terms and support pages, is now available in Arabic.\n- The interface mirrors completely: arrows, badges and toolbars follow the reading direction.\n- Counts, file sizes and scan dates are consistent across the app now, where one screen could previously show more than one format.\n\nEverything still runs on your device: no account, no uploads, and what you clear goes to Recently Deleted, where iOS keeps it for about 30 days.\n\nFeedback and bug reports are genuinely welcome — the support link on the App Store page reaches me directly.",
    },
    "uk": {
        ...
        "release_notes": "Арабська приєднується до Alike, і весь застосунок читається справа наліво.\n\n- Кожен екран, а також сторінка в App Store і сторінки приватності, умов та підтримки, тепер доступні арабською.\n- Інтерфейс дзеркалиться повністю: стрілки, позначки й панелі йдуть за напрямком читання.\n- Кількості, розміри файлів і дати сканувань тепер узгоджені в усьому застосунку — раніше на одному екрані міг бути не один формат.\n\nУсе так само виконується на вашому пристрої: без облікового запису й без вивантаження, а прибране потрапляє до «Нещодавно видалених», де iOS зберігає його близько 30 днів.\n\nВідгуки та повідомлення про помилки дуже вітаються — посилання на підтримку на сторінці App Store веде безпосередньо до розробника.",
    },
    ...
    "de-DE": {
        ...
        "release_notes": "Arabisch kommt zu Alike dazu, und die ganze App liest von rechts nach links.\n\n- Jeder Bildschirm, dazu die App-Store-Seite und die Seiten zu Datenschutz, Nutzungsbedingungen und Support, ist jetzt auf Arabisch verfügbar.\n- Die Oberfläche spiegelt sich vollständig: Pfeile, Abzeichen und Symbolleisten folgen der Leserichtung.\n- Anzahlen, Dateigrößen und Scan-Daten sind jetzt in der ganzen App einheitlich — vorher konnte ein einzelner Bildschirm mehr als ein Format zeigen.\n\nAlles läuft weiterhin auf deinem Gerät: kein Konto, keine Uploads, und was du aufräumst, geht nach „Zuletzt gelöscht“, wo iOS es rund 30 Tage aufbewahrt.\n\nRückmeldungen und Fehlerberichte sind ausdrücklich willkommen — der Support-Link auf der App-Store-Seite erreicht mich direkt.",
    },
    "fr-FR": {
        ...
        "release_notes": "L'arabe rejoint Alike, et toute l'app se lit de droite à gauche.\n\n- Tous les écrans, ainsi que la page App Store et les pages de confidentialité, de conditions et d'assistance, sont désormais disponibles en arabe.\n- L'interface se reflète entièrement : les flèches, les pastilles et les barres d'outils suivent le sens de lecture.\n- Les nombres, les tailles de fichiers et les dates d'analyse sont maintenant cohérents dans toute l'app, là où un même écran pouvait afficher plusieurs formats.\n\nTout se passe toujours sur votre appareil : aucun compte, aucun envoi, et ce que vous nettoyez part dans « Supprimés récemment », où iOS le conserve environ 30 jours.\n\nVos retours et vos rapports de bugs sont sincèrement bienvenus — le lien d'assistance sur la page App Store me parvient directement.",
    },
    "es-ES": {
        ...
        "release_notes": "El árabe se suma a Alike, y toda la app se lee de derecha a izquierda.\n\n- Todas las pantallas, además de la página de App Store y las páginas de privacidad, condiciones y soporte, ya están disponibles en árabe.\n- La interfaz se refleja por completo: las flechas, los distintivos y las barras de herramientas siguen el sentido de lectura.\n- Los recuentos, los tamaños de archivo y las fechas de análisis son ahora coherentes en toda la app, donde antes una misma pantalla podía mostrar más de un formato.\n\nTodo sigue ejecutándose en tu dispositivo: sin cuenta, sin subidas, y lo que limpias va a «Eliminados recientemente», donde iOS lo guarda unos 30 días.\n\nLos comentarios y los informes de errores son muy bienvenidos: el enlace de soporte de la página de App Store llega directamente a mí.",
    },
    "es-MX": {
        "subtitle": "Encuentra y limpia duplicados",
        ...
        "promotional_text": "Alike agrupa las fotos que se parecen, elige la mejor toma de cada grupo y te ayuda a limpiar el resto, en tu iPhone. Alike Pro: 7 días gratis en el plan anual.",
        "release_notes": "El árabe se suma a Alike, y toda la app se lee de derecha a izquierda.\n\n- Todas las pantallas, además de la página de App Store y las páginas de privacidad, términos y soporte, ya están disponibles en árabe.\n- La interfaz se refleja por completo: las flechas, los distintivos y las barras de herramientas siguen el sentido de lectura.\n- Los conteos, los tamaños de archivo y las fechas de análisis ahora son consistentes en toda la app, donde antes una misma pantalla podía mostrar más de un formato.\n\nTodo sigue ejecutándose en tu dispositivo: sin cuenta, sin subidas, y lo que limpias va a «Eliminados recientemente», donde iOS lo guarda unos 30 días.\n\nLos comentarios y los reportes de errores son muy bienvenidos: el enlace de soporte de la página de App Store llega directamente a mí.",
    },
    "pt-BR": {
        ...
        "release_notes": "O árabe se junta ao Alike, e o app inteiro é lido da direita para a esquerda.\n\n- Todas as telas, além da página da App Store e das páginas de privacidade, termos e suporte, já estão disponíveis em árabe.\n- A interface espelha por completo: as setas, os selos e as barras de ferramentas seguem o sentido da leitura.\n- As contagens, os tamanhos de arquivo e as datas das análises agora são consistentes em todo o app, onde antes uma mesma tela podia mostrar mais de um formato.\n\nTudo continua rodando no seu dispositivo: sem conta, sem envios, e o que você limpa vai para «Apagados recentemente», onde o iOS guarda por cerca de 30 dias.\n\nComentários e relatos de erros são muito bem-vindos — o link de suporte na página da App Store chega direto a mim.",
    },
    ...
    "it": {
        ...
        "release_notes": "L'arabo si aggiunge ad Alike, e tutta l'app si legge da destra a sinistra.\n\n- Ogni schermata, più la pagina App Store e le pagine di privacy, condizioni e assistenza, è ora disponibile in arabo.\n- L'interfaccia si specchia per intero: frecce, badge e barre degli strumenti seguono il senso di lettura.\n- Conteggi, dimensioni dei file e date delle scansioni sono ora coerenti in tutta l'app, dove prima una stessa schermata poteva mostrare più di un formato.\n\nTutto avviene ancora sul tuo dispositivo: nessun account, nessun caricamento, e ciò che elimini finisce in «Eliminati di recente», dove iOS lo conserva per circa 30 giorni.\n\nCommenti e segnalazioni sono davvero benvenuti: il link di assistenza sulla pagina App Store arriva direttamente a me.",
    },
    "nl-NL": {
        ...
        "release_notes": "Arabisch komt erbij, en de hele app leest van rechts naar links.\n\n- Elk scherm, plus de App Store-pagina en de pagina's over privacy, voorwaarden en ondersteuning, is nu beschikbaar in het Arabisch.\n- De interface spiegelt volledig: pijlen, badges en werkbalken volgen de leesrichting.\n- Aantallen, bestandsgroottes en scandata zijn nu consistent door de hele app, waar één scherm eerder meer dan één notatie kon tonen.\n\nAlles draait nog steeds op je apparaat: geen account, geen uploads, en wat je opruimt gaat naar 'Recent verwijderd', waar iOS het ongeveer 30 dagen bewaart.\n\nReacties en foutmeldingen zijn oprecht welkom — de ondersteuningslink op de App Store-pagina komt rechtstreeks bij mij terecht.",
    },
    "pl": {
        ...
        "release_notes": "Arabski dołącza do Alike, a cała aplikacja czyta się od prawej do lewej.\n\n- Każdy ekran, a do tego strona w App Store oraz strony prywatności, warunków i pomocy, są już dostępne po arabsku.\n- Interfejs odbija się w całości: strzałki, plakietki i paski narzędzi podążają za kierunkiem czytania.\n- Liczby, rozmiary plików i daty skanowań są teraz spójne w całej aplikacji — wcześniej jeden ekran potrafił pokazać więcej niż jeden format.\n\nWszystko nadal działa na Twoim urządzeniu: bez konta, bez wysyłania czegokolwiek, a to, co uporządkujesz, trafia do „Ostatnio usuniętych”, gdzie iOS trzyma je około 30 dni.\n\nUwagi i zgłoszenia błędów są naprawdę mile widziane — link do pomocy na stronie App Store trafia bezpośrednio do mnie.",
    },
    "tr": {
        ...
        "release_notes": "Arapça Alike'a katıldı ve uygulamanın tamamı sağdan sola okunuyor.\n\n- Her ekran, ayrıca App Store sayfası ve gizlilik, koşullar ve destek sayfaları artık Arapça olarak sunuluyor.\n- Arayüz baştan sona aynalanıyor: oklar, rozetler ve araç çubukları okuma yönünü izliyor.\n- Sayılar, dosya boyutları ve tarama tarihleri artık uygulamanın her yerinde tutarlı; daha önce tek bir ekran birden fazla biçim gösterebiliyordu.\n\nHer şey yine cihazında çalışıyor: hesap yok, yükleme yok; temizlediklerin Son Silinenler'e gider, iOS onları yaklaşık 30 gün orada tutar.\n\nGeri bildirimler ve hata bildirimleri gerçekten memnuniyetle karşılanır — App Store sayfasındaki destek bağlantısı doğrudan bana ulaşır.",
    },
    "zh-Hant": {
