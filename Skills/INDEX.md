...
| `External/xcode-disk-cleanup` | Low disk space, DerivedData, simulator runtimes, archives, dSYMs, Xcode caches; audit before any deletion | This is external depth; measure first, delete only itemized approved items, never release evidence | Yes (audit) |
